...
const reservations = [] //To Do: import reservations from its storeå
        ...
        <v-form @submit.prevent >
            <v-card>
                ...
                <v-card-text>
                    <v-row dense>
                        <v-col >
                            <v-text-field label="Name" v-model="menuName"></v-text-field>
                        </v-col>
                    </v-row>
                        ...
                        <v-col cols="12" md="10" sm="6">
                            <v-radio-group v-model="category">
                                <v-row>
                                    ...
                                    <v-col cols="12" md="4" sm="6" >
                                        <v-radio label="Snack" value="4"></v-radio>
                                    </v-col>
                                </v-row>
                                <v-row dense>
                                <v-col >
                ...
                <v-card-actions>
                    <v-spacer></v-spacer>
                    <v-btn text="Close" variant="plain" @click="close()" ></v-btn>
                    <v-btn color="primary" type="submit" text="Save" variant="tonal" @click="addMenu()" ></v-btn>
                </v-card-actions>
            </v-card>
        </v-form>
    </v-dialog>
